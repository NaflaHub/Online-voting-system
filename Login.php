...
<body>
    <div class="login">
        ...
        <form action="" method="POST">
            <center>
            <input type="email" name="Email" required placeholder="Email" autocapitalize="off" autocomplete="off" autocorrect="off" spellcheck="false"><br>
